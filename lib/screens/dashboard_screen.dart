                ...
                children: [
                    ...
                    child: _dailyFocus.isEmpty
                        ...
                        : BarChart(
                            BarChartData(
                              ...
                              barGroups: _dailyFocus
                                  .asMap()
                                  .entries
                                  .map((entry) {
                                final seconds = (entry.value[
                                        'total_seconds'] as num)
                                    .toDouble();
                  ...
                  if (_listStats.isNotEmpty) ...[
                    ...
                    GlassCard(
                      ...
                      child: Column(
                        children: _listStats.map((stat) {
                          final total = stat['total'] as int? ?? 0;
                          final completed =
                              stat['completed'] as int? ?? 0;
                          final color =
                              Color(stat['color'] as int? ?? 0xFF2196F3);
                          return Padding(
